...
def get_in_scm_pgnd_condns():
    return actions.MaskedCondns(AC_IN_SCM_PGND if scm_gui_ifce.SCM.in_valid_wspce else AC_NOT_IN_SCM_PGND, AC_IN_SCM_PGND_MASK)
...
_update_class_indep_scm_pgnd_cb()
